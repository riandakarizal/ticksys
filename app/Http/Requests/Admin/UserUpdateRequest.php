...
class UserUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'user_role'   => ['required', 'in:user,siteadmin,admin,superadmin,vip,fin'],
            'user_unit'   => ['required', 'in:-,Technology Operation & Maintenance,Equipment Operation & Maintenance,Technology Commercial,Equipment Commercial,Asset'],
            'user_div'    => ['required', 'in:-,Equipment & Technology Commercial,Equipment & Technology Operation & Maintenance,Finance'],
